...
def load_dataset(data_dir, dataset_name):
    ...
    # elif "DLPFC" in data_dir:
    #     pass
    # elif "BC" in data_dir:
    #     pass
    # elif "mHypothalamus" in data_dir:
    #     pass
    # elif "mMAMP" in data_dir:
    #     pass
    # elif "other dataset" in data_dir:
    #     # TODO
    #     pass
...
# def setup_training_data_ST(dataset_name, data_dir):
#     feats, graph = load_dataset(data_dir, dataset_name)
